    ...
    return (
        <div className='relative mx-20'>
            ...
            <div className='ml-[30%] text-left'>
                <Fade bottom delay={500}><p className='text-xl font-semibold'>SERVICES-(2)</p></Fade>
                <Fade bottom delay={600}><h1 className='text-[60px] font-bold leading-[70px]'>OUR MARKETING <br /> SERVICES - (2)</h1></Fade>
            </div>
            ...
            <nav className='p-10'>
                <div className="vsb1">
                    <li className=''>
                        <div className="link">
                            <h1 className='text-[32px] font-bold'>SOCIAL<br /> MARKETING</h1>
                            <p className=' text-lg'>We help brands stand out through aweful, elegant <br /> visual design. Our design mainly philosophy. <br />
                                <span>+ Logo Design</span> <br />
                                <span>+ Advertisement</span> <br />
                                <span>+ Promotion </span>
                            ...
                            <div className="hover-reveal">
                                <img src={content} className="hidden-img" alt="" />
                            </div>
                        </div>
                    </li>
                </div>
